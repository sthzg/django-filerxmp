...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'XMPBase.item'
        db.delete_column(u'filerxmp_xmpbase', 'item_id')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'XMPBase.item'
        raise RuntimeError("Cannot reverse this migration. 'XMPBase.item' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'XMPBase.item'
        db.add_column(u'filerxmp_xmpbase', 'item',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='related_item', to=orm['filersets.Item']),
                      keep_default=False)
    ...
    models = {
        ...
        u'filerxmp.xmpbase': {
            ...
            'file': ('django.db.models.fields.related.OneToOneField', [], {'default': 'None', 'related_name': "'file_xmpbase'", 'unique': 'True', 'to': "orm['filer.File']"}),
