...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'XMPBase.item'
        db.add_column(u'filerxmp_xmpbase', 'item',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='related_item', to=orm['filersets.Item']),
                      keep_default=False)
    ...
    models = {
        ...
        u'filerxmp.xmpbase': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_processed': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'item': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'related_item'", 'to': u"orm['filersets.Item']"}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
